...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_nombre_producto { top: 4mm; right: 3mm; font-weight: 600; text-align: right; font-size: 7pt; line-height: 1pt; }
        ...
        .A4-8 .box .box_promo h1 .signo_peso { font-size: 27pt; letter-spacing: -10px; vertical-align: center; margin-right: 2mm; }
        .A4-8 .box .box_promo h1 .signo_por { font-size: 27pt; letter-spacing: -10px; vertical-align: ; margin-right: 2mm; }
        ...
        .A4-8.franja_oferta .box .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-jumbo.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
        .clear {clear: both}
    </style>
</head>
<body>
    <div class="cont-grid cont-a4-8">
        <div class="A4-8 franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">3</span><span class="signo_por_big">X</span><span class="porcentaje">2</span></h1>
                    </div>
                </div>
                ...
                <div class="box_condiciones">
                    ...
                    <p class="s-text"><strong>VALIDAS DESDE EL 29/11/2019 AL 31/12/2019</strong> O HASTA AGOTAR STOCK MAXIMO 12 PROMOCIONES POR PERSONAS. NO APLICA A COMPRAS CON FACTURA. NO ACUMULABLE CON OTRAS PROMOCIONES</p>
                </div>
    ...
    <div class="cont-grid cont-a4-8">
        ...
        <div class="A4-8 franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+0]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+0]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+1]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+1]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+2]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+2]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+3]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+3]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+4]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+4]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+5]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+5]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+6]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+6]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+7]->tmp, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+7]->tmp, -1)}}</span></h1>
                    </div>
                </div>
