...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo h1.n_por_n { font-size: 0; letter-spacing: 0;text-transform: lowercase;}
        .A4-8 .box .box_promo h1.n_por_n .signo_por_big { font-size: 70pt; }
        .A4-8 .box .box_promo h1.n_por_n .porcentaje { font-size: 90pt; line-height: 70pt; }
        ...
        .A4-8 .box .box_precio_normal { position: absolute; top: 41mm; height: 2mm; width: 102mm; left: 0; text-align: right; /*background-color: bisque; */ }
        ...
        /*.A4-8.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 50px; background-position: 18mm 40%; } */
        ...
        .A4-8.franja_tarjeta .box .box_promo h1.n_por_n { font-size: 90pt; line-height: 60pt; }
        ...
        .A4-8.franja_tarjeta .box .box_promo h2 { display: flex; align-items: center; margin-left: 110px; margin-top: -24px; font-size: 26pt; position: relative; color: #E00C15; }
        .A4-8.franja_tarjeta .box .box_promo h2 .todo_pago { font-size: 9.2pt; line-height: 1; text-align: left; margin-left: 10px; color: #000; }
        ...
        .A4-8.franja_tarjeta .box .box_promo .img-logo {position: absolute; left: 16mm; top: 8mm; width: 60px;}
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-8">
        ...
        <div class="A4-8 franja_tarjeta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+4]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+4]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+5]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+5]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+6]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+6]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+7]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+7]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
