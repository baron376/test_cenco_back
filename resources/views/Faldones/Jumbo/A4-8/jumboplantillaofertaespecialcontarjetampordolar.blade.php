...
<head>
    ...
    <style>
       * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo h1.prod_por_precio { font-size: 45pt; letter-spacing: 0; line-height: 30pt;}
        ...
        /* .A4-8.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: contain; background-position: 9mm 0; } */
        ...
        .A4-8.franja_tarjeta .box .box_promo h1.prod_por_precio { font-size: 35pt; }
        ...
        .A4-8.franja_tarjeta .box .box_promo h2 { font-size: 35pt; position: relative; color: #E00C15; letter-spacing: 0; line-height: 30pt;}
        .A4-8.franja_tarjeta .box .box_promo h2 .todo_pago { font-size: 10pt; line-height: .8; text-align: center; color: #000; position: absolute; top: 3mm;
        left: 0; width: 30mm; letter-spacing: 0;}
        .A4-8.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 3mm; }
        .A4-8.franja_tarjeta .box .box_promo h2 .punto { font-size: 18pt; }
        .A4-8.franja_tarjeta .box .box_promo h2 .signo_por { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 3mm;  }
        ...
        .A4-8.franja_tarjeta .box .box_promo h2.precio_otro_medio_pago .todo_pago { font-size: 10pt; }
        .A4-8.franja_tarjeta .box .box_promo h2.produc_por_precio_otro_pago { }
        ...
        .A4-8.franja_tarjeta .box .box_promo h1.prod_por_precio,
        .A4-8.franja_tarjeta .box .box_promo h2.produc_por_precio_otro_pago {position: absolute; height: 12mm; right: 2mm; /*border: 1px solid #000;*/ width: 100%;}
        .A4-8.franja_tarjeta .box .box_promo h1.prod_por_precio {top: 0;}
        .A4-8.franja_tarjeta .box .box_promo h2.produc_por_precio_otro_pago {top: 14mm;} 
    ...
    <div class="cont-grid cont-a4-8">
        ...
        <div class="A4-8 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+0]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+0]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+0]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+0]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
        ...
        <div class="A4-8 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+1]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+1]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+1]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+1]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+2]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+2]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+2]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+2]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+3]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+3]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+3]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+3]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+4]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+4]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+4]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+4]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+4]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+5]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+5]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+5]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+5]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+5]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+6]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+6]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+6]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+6]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+6]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio">{{substr($product[$i+7]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+7]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+7]->tmp > 0)
                        <h2 class="produc_por_precio_otro_pago">{{substr($product[$i+7]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+7]->tmp, 0, '', '.')}}<div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
