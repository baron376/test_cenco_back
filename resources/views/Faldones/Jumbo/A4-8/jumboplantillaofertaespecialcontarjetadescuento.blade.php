...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo h1.porcentaje_mas_promo .ic-porcentaje { font-size: 30pt; top: 2mm; right: -4mm;}
        ...
        .A4-8 .box .box_promo h2 { font-size: 16pt; font-weight: 900; color: #E00C15;}
        ...
        /* .A4-8.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 45px; background-position:30% 0; } */
        ...
        .A4-8.franja_tarjeta .box .box_promo h1.solo_porcentaje,
        .A4-8.franja_tarjeta .box .box_promo h2.otro_medio_pago {position: absolute; height: 12mm; right: 8mm; /*border: 1px solid #000;*/ width: 100%;}
