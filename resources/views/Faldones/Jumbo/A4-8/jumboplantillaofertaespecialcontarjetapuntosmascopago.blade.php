...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo h1 { font-weight: 900; color: #E00C15; padding-right: 3.5mm;}
        ...
        .A4-8.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 45px; background-position: 10px 50%; }
