...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo h1 { font-weight: 900; color: #E00C15; }
        .A4-8 .box .box_promo h1 .signo_peso { font-size: 27pt; letter-spacing: -10px; vertical-align: bottom; margin-right: 2mm; }
        .A4-8 .box .box_promo h1 .punto { font-weight: 400; letter-spacing: 0; }
        .A4-8 .box .box_promo h1 .dcto { font-size: 8pt; }
        .A4-8 .box .box_promo h1 .porcentaje { font-size: 90pt; line-height: 40pt; }
        .A4-8 .box .box_promo h1 .ic-porcentaje { font-size: 35pt; position: absolute; top: -7mm; right: 0;}
        .A4-8 .box .box_promo h1.solo_precio { font-size: 64pt; line-height: 66pt; letter-spacing: -2px; margin-top: -5px; }
        .A4-8 .box .box_promo h1.solo_porcentaje { }
        .A4-8 .box .box_promo h1.porcentaje_mas_promo { margin-top: 3px; }
        .A4-8 .box .box_promo h1.porcentaje_mas_promo .porcentaje { font-size: 60pt; line-height: 30pt; }
        .A4-8 .box .box_promo h1.porcentaje_mas_promo .ic-porcentaje { font-size: 50pt; top: 0; right: 0;}
        ...
        .A4-8 .box .box_promo h2 { font-size: 16pt; font-weight: 900; }
        ...
        /*.A4-8.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 45px; background-position:20mm 0; } */
        .A4-8.franja_tarjeta .box .box_promo h1 .ic-porcentaje { font-size: 35pt;}
        .A4-8.franja_tarjeta .box .box_promo h1 .dcto { font-size: 8pt; letter-spacing: 0; }
        .A4-8.franja_tarjeta .box .box_promo h1.solo_precio { font-size: 62pt; letter-spacing: -1.2mm; margin-top: -15px; }
        ...
        .A4-8.franja_tarjeta .box .box_promo h1.solo_porcentaje {  }
        .A4-8.franja_tarjeta .box .box_promo h1.solo_porcentaje .porcentaje { font-size: 45pt; line-height: 30pt; }
        ...
        .A4-8.franja_tarjeta .box .box_promo h2 { font-size: 45pt; line-height: 30pt; color: #E00C15; text-align: right;}
        .A4-8.franja_tarjeta .box .box_promo h2 .todo_pago { font-size: 9.2pt; line-height: 1; text-align: left; color: #000; }
        .A4-8.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 12pt; vertical-align: middle; }
        .A4-8.franja_tarjeta .box .box_promo h2 .punto { font-size: 18pt; }
        .A4-8.franja_tarjeta .box .box_promo h2 .signo_por { font-size: 14pt; }
        .A4-8.franja_tarjeta .box .box_promo h2 .ic-porcentaje { font-size: 35pt; position: absolute; top: -2.5mm; right: 0;}
        .A4-8.franja_tarjeta .box .box_promo h2 .dcto { font-size: 8pt; letter-spacing: 0; }
        .A4-8.franja_tarjeta .box .box_promo h2.otro_medio_pago {}
        .A4-8.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { font-size: 9pt; top: 2mm; left: 25mm; text-align: center; position: absolute; width: 30mm; line-height: .8; letter-spacing: 0;}
        .A4-8.franja_tarjeta .box .box_promo h2.precio_otro_medio_pago { font-size: 18pt; }
        .A4-8.franja_tarjeta .box .box_promo h2.precio_otro_medio_pago .todo_pago { font-size: 8pt; }
        .A4-8.franja_tarjeta .box .box_promo h2.produc_por_precio_otro_pago { margin-left: 80px; }
        .A4-8.franja_tarjeta .box .box_promo h3 { font-weight: 900; font-size: 10pt; text-align: center; position: absolute; right: 6mm; line-height: 1; top: -2mm;}
        .A4-8.franja_tarjeta .box .box_promo h3 sup { font-size: 5pt; }
        ...
        .A4-8.franja_tarjeta .box .box_promo h1.solo_porcentaje,
        .A4-8.franja_tarjeta .box .box_promo h2.otro_medio_pago {position: absolute; height: 12mm; right: 2mm; /*border: 1px solid #000;*/ width: 100%;}
        .A4-8.franja_tarjeta .box .box_promo h1.solo_porcentaje {top: 3mm;}
        .A4-8.franja_tarjeta .box .box_promo h2.otro_medio_pago {top: 15mm;}
        
        .A4-8.franja_tarjeta .box .box_promo .img-logo {position: absolute; left: 35mm; top: 2mm; width: 50px;}
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-8">
        ...
        <div class="A4-8 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+0]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+0]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+0]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
        ...
        <div class="A4-8 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+1]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+1]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+1]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+2]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+2]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+2]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+3]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+3]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+3]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+4]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+4]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+4]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+5]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+5]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+5]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+6]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+6]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+6]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3>2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+7]->tc}}</span><span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span></h1>
                        @if($product[$i+7]->tmp > 0)
                        <h2 class="otro_medio_pago">{{$product[$i+7]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
