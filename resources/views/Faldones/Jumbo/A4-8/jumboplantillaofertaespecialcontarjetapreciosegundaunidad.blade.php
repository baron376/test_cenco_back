...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8.franja_tarjeta .box .box_promo h3.segunda_unidad { text-align: center; position: absolute; line-height: 1; top: 0; right: 14mm;}
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+0]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+0]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
        ...
        <div class="A4-8 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+1]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+1]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+2]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+2]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+3]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+3]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+4]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+4]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+4]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+5]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+5]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+5]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+6]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+6]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+6]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-8 franja_tarjeta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h3>
                        <h1 class="precio_mas_promo "><span class="signo_peso">$</span>{{number_format($product[$i+7]->tc, 0, '', '.')}}</h1>
                        @if($product[$i+7]->tmp > 0)
                        <h2 class="precio_otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+7]->tmp, 0, '', '.')}} <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
