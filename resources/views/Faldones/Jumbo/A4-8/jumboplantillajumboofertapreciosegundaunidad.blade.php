...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo { position: absolute; width: 101mm; height: 24mm; top: 10mm; text-align: right; }
        .A4-8 .box .box_promo h1 { font-size: 45pt; font-weight: 900; color: #E00C15; }
        .A4-8 .box .box_promo h1 .signo_peso { font-size: 45pt; letter-spacing: -10px; vertical-align: bottom; margin-right: 2mm; }
        ...
        .A4-8 .box .box_promo h1.porcentaje_mas_promo { margin-top: 10px; }
        .A4-8 .box .box_promo h1.porcentaje_mas_promo .porcentaje { font-size: 75pt; line-height: 40pt; }
        .A4-8 .box .box_promo h1.porcentaje_mas_promo .ic-porcentaje { font-size: 50pt; margin-right: -55px; top: -10px; }
        ...
        .A4-8 .box .box_promo .segunda_unidad { position: absolute; left: 60mm; top: 0mm; font-size: 10pt;}
