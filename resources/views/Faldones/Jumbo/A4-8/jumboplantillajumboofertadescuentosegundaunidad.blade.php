...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo { position: absolute; width: 101mm; height: 24mm; top: 15mm; text-align: right; }
        ...
        .A4-8 .box .box_precio_normal { position: absolute; top: 42mm; height: 2mm; width: 102mm; left: 0; text-align: right; /*background-color: bisque; */ }
        ...
        .A4-8 .box .box_promo .segunda_unidad { position: absolute; left: 60mm; top: -2mm; font-size: 10pt;}
        .A4-8 .box .box_promo .segunda_unidad sup { font-size: 5pt; }
        .clear {clear: both}
    </style>
</head>
<body>
        ...
        <div class="A4-8 franja_oferta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+4]->tmp}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+5]->tmp}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+6]->tmp}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="solo_porcentaje"><span class="porcentaje">{{$product[$i+7]->tmp}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    </div>
                </div>
