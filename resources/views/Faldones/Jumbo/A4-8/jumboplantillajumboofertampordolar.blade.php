...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-8 .box .box_promo { position: absolute; width: 101mm; height: 24mm; top: 17mm; text-align: right; }
        .A4-8 .box .box_promo h1 { font-weight: 900; color: #E00C15; }
        .A4-8 .box .box_promo h1.prod_por_precio { font-size: 50pt; letter-spacing: 0; line-height: 30pt;}
        .A4-8 .box .box_promo h1.prod_por_precio .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: top; margin-right: 3mm; }
        .A4-8 .box .box_promo h1.prod_por_precio .signo_por { font-size: 21pt; letter-spacing: -10px; vertical-align: top; margin-right: 3mm; }
        ...
        .A4-8 .box .box_franja_inferior {top: 54mm; height: 20mm; background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-oferta.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
        .clear {clear: both}
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-8">
        ...
        <div class="A4-8 franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+0]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+1]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+2]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+3]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_05">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+4]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+4]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_06">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+5]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+5]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_07">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+6]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+6]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-8 franja_oferta faldon_08">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio"><span class="prod_qty">{{substr($product[$i+7]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+7]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
