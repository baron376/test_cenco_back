...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo h2.segunda_unidad { font-size: 24pt; color: #000; font-weight: 900; margin-top: -3mm; }
        .A4-4-cuotas .box .box_promo h2.segunda_unidad sup{ font-size: 14pt; font-weight: 900;}
        ...
        .A4-4-cuotas .box .box_promo h3 sup { font-size: 7pt; }
        .A4-4-cuotas .box .box_promo h3.segunda_unidad { position: absolute; left: 100mm; top: -6mm; font-size: 17pt; font-weight: 900;}
        .A4-4-cuotas .box .box_cuotas { position: absolute; top: 62mm;width: 100%; right: 0; text-align: center;}
        ...
        /*.A4-4-cuotas .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 90px; background-position: 0 0;} */
        
        .clear {clear: both}
        
        .A4-4-cuotas.con_franja_oferta .box .box_promo .img-logo {position: absolute; left: 20mm; top: 10mm; width: 70px;}
    </style>
</head>
<body>
