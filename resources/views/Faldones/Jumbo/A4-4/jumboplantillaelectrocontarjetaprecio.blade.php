...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo h1 { font-weight: 900; font-size: 90pt; line-height: 80pt; color: #E00C15; letter-spacing: -2px; }
        ...
        .A4-4-cuotas.con_franja_oferta .box .box_promo .img-logo {position: absolute; left: 6mm; top: 10mm; width: 70px;}
    </style>
</head>
<body>
