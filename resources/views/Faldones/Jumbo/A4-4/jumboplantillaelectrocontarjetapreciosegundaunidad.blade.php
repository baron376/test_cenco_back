...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo { position: absolute; /* background-color: aquamarine; */ width: 140mm; height: 30mm; left: 4mm; top: 19mm; text-align: right; }
        ...
        .A4-4-cuotas .box .box_promo h2 {margin-left: 130px; margin-top: 0; font-size: 46pt; position: relative; color: #E00C15; }
        ...
        .A4-4-cuotas .box .box_promo h2.segunda_unidad { font-size: 24pt; color: #000; margin-bottom: -4mm; font-weight: 900;}
        .A4-4-cuotas .box .box_promo h2.segunda_unidad sup { font-weight: 900; font-size: 16pt;}
        ...
        .A4-4-cuotas .box .box_promo h3.segunda_unidad { position: absolute; left: 100mm; top: -10mm; font-size: 17pt; font-weight: 900;}
        ...
        .A4-4-cuotas .box .box_precio_normal { position: absolute; top: 70mm; height: 4mm; width: 69mm; right: 6mm; text-align: right; /* background-color: bisque; */ }
        .A4-4-cuotas .box .box_precio_normal p { font-size: 8pt; text-transform: uppercase; }
        .A4-4-cuotas .box .box_condiciones { position: absolute; top: 76mm; left: 2mm; width: 142mm; height: 16mm; /* background-color: cadetblue; */ }
        
        .A4-4-cuotas .box .box_condiciones.pre { width: 69mm; height: 4mm; top: 70mm;}
        ...
        /*.A4-4-cuotas .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 0 8mm;} */
        
        .clear {clear: both}
        
        .A4-4-cuotas.con_franja_oferta .box .box_promo .img-logo {position: absolute; left: 6mm; top: 14mm; width: 70px;}
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h2 class="segunda_unidad">2<sup>DA</sup> UNIDAD</h2>
