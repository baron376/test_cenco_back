...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo { position: absolute; width: 140mm; height: 30mm; left: 4mm; top: 24mm; text-align: right; }
        ...
        .A4-4-cuotas .box .box_promo h1.solo_precio { letter-spacing: -1.2mm; margin-top: 0; font-size: 45pt; line-height: 30pt;}
        ...
        .A4-4-cuotas .box .box_promo h2 { font-size: 45pt; line-height: 30pt; color: #E00C15; font-weight: 900;letter-spacing: -1.2mm;}
        .A4-4-cuotas .box .box_promo h2 .todo_pago { font-size: 10pt; line-height: 1; text-align: center; color: #000; position: absolute; letter-spacing: 0; top: 2mm; left: 6mm; width: 35mm; line-height: .8;}
        ...
        /*.con_franja_oferta_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 65px; background-position: 14mm 0; } */
