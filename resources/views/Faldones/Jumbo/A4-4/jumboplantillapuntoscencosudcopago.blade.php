...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo { position: absolute; /* background-color: aquamarine; */ width: 140mm; height: 30mm; left: 4mm; top: 35mm; text-align: right; }
        .A4-4-cuotas .box .box_promo h1 { font-weight: 900; font-size: 90pt; line-height: 72pt; color: #E00C15; letter-spacing: -2px; }
        .A4-4-cuotas .box .box_promo h1 .signo_peso { font-size: 45pt; letter-spacing: -10px; vertical-align: middle; margin-right: 2mm; }
        ...
        .A4-4-cuotas .box .box_promo h1.prod_por_precio .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 3mm; }
        .A4-4-cuotas .box .box_promo h1.prod_por_precio .signo_por { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 4mm; margin-left: 2mm; }
        ...
        .A4-4-cuotas .box .box_promo h2 { color: #E00C15; }
        .A4-4-cuotas .box .box_promo h2 .todo_pago { font-size: 12pt; line-height: 1; text-align: left; margin-left: 10px; color: #000; }
        .A4-4-cuotas .box .box_promo h2 .signo_peso { font-size: 12pt; vertical-align: top; }
        ...
        .A4-4-cuotas .box .box_cuotas { position: absolute; top: 55mm; width: 84mm; right: 0; text-align: center; }
        ...
        .A4-4-cuotas.con_puntos .box .box_promo { text-align: center; color: #7F0A7E; }
        .A4-4-cuotas.con_puntos .box .box_promo h1 { font-size: 90pt; margin-top: -25px; margin-bottom: 0px; color: #7F0A7E; }
        .A4-4-cuotas.con_puntos .box .box_promo h2 { font-size: 24pt; position: absolute; top: 18mm; left: 30mm; }
        .A4-4-cuotas.con_puntos .box .box_promo h3 { font-size: 30pt;position: absolute; top: 30mm; left: 40mm; }
        /* .A4-4-cuotas.con_puntos .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/faldon-sisa-puntos.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; } */
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4-cuotas con_franja_oferta con_puntos faldon_01">
            <div class="box">
                @if($product[$i+0]->qr != 2)
                <div class="box_qr">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="solo_puntos"> {{number_format($product[$i+0]->tmp, 0, '', '.')}}</h1>
                        <h2>PUNTOS CENCOSUD</h2>
                        @if($product[$i+0]->tc > 0)
                        <h3>+<span class="signo_peso">$</span> {{number_format($product[$i+0]->tc, 0, '', '.')}}</h3>
                        @endif
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta con_puntos faldon_02">
            <div class="box">
                @if($product[$i+1]->qr != 2)
                <div class="box_qr">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="solo_puntos"> {{number_format($product[$i+1]->tmp, 0, '', '.')}}</h1>
                        <h2>PUNTOS CENCOSUD</h2>
                        @if($product[$i+1]->tc > 0)
                        <h3>+<span class="signo_peso">$</span> {{number_format($product[$i+1]->tc, 0, '', '.')}}</h3>
                        @endif
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta con_puntos faldon_03">
            <div class="box">
                @if($product[$i+2]->qr != 2)
                <div class="box_qr">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="solo_puntos"> {{number_format($product[$i+2]->tmp, 0, '', '.')}}</h1>
                        <h2>PUNTOS CENCOSUD</h2>
                        @if($product[$i+2]->tc > 0)
                        <h3>+<span class="signo_peso">$</span> {{number_format($product[$i+2]->tc, 0, '', '.')}}</h3>
                        @endif
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta con_puntos faldon_04">
            <div class="box">
                @if($product[$i+3]->qr != 2)
                <div class="box_qr">
                ...
                <div class=" bottom" style="font-size: 19pt; text-align: right; padding: 20px 20px 0 95px; line-height: 1;">
                    <h2>{{$product[$i+3]->nombre_generico_promocion}}</h2>
                </div>
                @endif
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="solo_puntos"> {{number_format($product[$i+3]->tmp, 0, '', '.')}}</h1>
                        <h2>PUNTOS CENCOSUD</h2>
                        @if($product[$i+3]->tc > 0)
                        <h3>+<span class="signo_peso">$</span> {{number_format($product[$i+3]->tc, 0, '', '.')}}</h3>
                        @endif
                    </div>
                </div>
