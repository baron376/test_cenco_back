...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4 .box .box_promo { position: absolute; width: 140mm; height: 30mm; left: 4mm; top: 28mm; text-align: right; }
        
        .A4-4 .box .box_promo h1 { font-weight: 900; font-size: 60pt; line-height: 40pt; color: #E00C15; letter-spacing: -2px; }
        .A4-4 .box .box_promo h1 .signo_peso { font-size: 45pt; letter-spacing: -10px; vertical-align: bottom;  margin-right: 2mm;}
        .A4-4 .box .box_promo h1 .punto { font-weight: 400; letter-spacing: 0; }
        .A4-4 .box .box_promo h1 .dcto { font-size: 18pt; letter-spacing: 0;}
        /* .A4-4 .box .box_promo h1 .porcentaje { font-size: 160pt; line-height: 110pt; } */
        .A4-4 .box .box_promo h1 .ic-porcentaje { font-size: 48pt; margin-right: -50px; position: absolute; top: -5px; }
        ...
        .A4-4 .box .box_promo h1.porcentaje_mas_promo .porcentaje { font-size: 60pt; line-height: 40pt; }
        .A4-4 .box .box_promo h1.porcentaje_mas_promo .ic-porcentaje { font-size: 80pt; margin-right: -50px; top: 20px; }
        .A4-4 .box .box_promo h1.porcentaje_mas_promo .dcto { font-size: 18pt; }
        ...
        .A4-4 .box .box_promo h2 { font-weight: 900; font-size: 60pt; line-height: 40pt; text-align: right; color: #E00C15;}
        .A4-4 .box .box_promo h2 sup { font-size: 21px; font-weight: 900; margin-right: 2px; }
        /* .A4-4 .box .box_promo h2 { display: flex; align-items: center; margin-left: 130px; margin-top: -30px; font-size: 46pt; position: relative; color: #E00C15; } */
        
        .A4-4 .box .box_cuotas { position: absolute; top: 62mm;width: 100%; left: 0; text-align: center;}
        ...
        /* .A4-4.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 65px; background-position: 30mm 0; } */

        .A4-4.franja_tarjeta .box .box_promo h1 .ic-porcentaje { font-size: 48pt; position: absolute; top: -4mm; right: 14mm;}
        .A4-4.franja_tarjeta .box .box_promo h1 .dcto { font-size: 12pt; }
        ...
        .A4-4.franja_tarjeta .box .box_promo h1.solo_porcentaje .porcentaje { font-size: 60pt; line-height: 40pt;}
        ...
        .A4-4.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 12pt; vertical-align: middle; }
        .A4-4.franja_tarjeta .box .box_promo h2 .punto { font-size: 18pt; }
        .A4-4.franja_tarjeta .box .box_promo h2 .signo_por { font-size: 14pt; }
        .A4-4.franja_tarjeta .box .box_promo h2 .ic-porcentaje { font-size: 48pt; position: absolute; top: -4mm; right: 0; }
        .A4-4.franja_tarjeta .box .box_promo h2 .dcto { font-size: 12pt; letter-spacing: 0;}
        
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago { position: relative;}
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { position: absolute; left: 20mm; top: 2mm; width: 35mm; line-height: .8; letter-spacing: 0; text-align: center;}
        ...
        .A4-4 .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-tarjeta_a4-4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
        .clear {clear: both}
        
        .A4-4.franja_tarjeta .box .box_promo h1.solo_porcentaje,
        ...
        .A4-4.franja_tarjeta .box .box_promo h1.solo_porcentaje {top: 2mm; right: -6mm;}
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago {top: 20mm;}
        
        .A4-4.franja_tarjeta .box .box_promo .img-logo {position: absolute; left: 33mm; top: 4mm; width: 60px;}
    </style>
</head>
<body>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago" style="margin: 15px 3px 0 0;">{{$product[$i+0]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON OTRO MEDIO DE PAGO</div></h2>
                        @endif
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago" style="margin: 15px 3px 0 0;">{{$product[$i+1]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago" style="margin: 15px 3px 0 0;">{{$product[$i+2]->tmp}}<span class="ic-porcentaje">%</span><span class="dcto">DCTO.</span><div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
