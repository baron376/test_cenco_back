...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        /*.A4-4-cuotas .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 90px; background-position: 0 8mm;}*/
        
        .clear {clear: both}
        
        .A4-4-cuotas.con_franja_oferta .box .box_promo .img-logo {position: absolute; left: 0; top: 10mm; width: 70px;}
    </style>
</head>
<body>
