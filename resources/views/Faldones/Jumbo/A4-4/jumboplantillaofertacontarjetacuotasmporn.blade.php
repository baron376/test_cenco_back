...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo { position: absolute; /* background-color: aquamarine; */ width: 140mm; height: 26mm; left: 4mm; top: 28mm; text-align: right; }
        ...
        /* .con_franja_oferta_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 65px; background-position: 0 6mm; } */
        ...
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo .img-logo {position: absolute; left: 20mm; top: 4mm; width: 80px;}
    </style>
