...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo { position: absolute; width: 140mm; height: 24mm; left: 4mm; top: 38mm; text-align: right; /*border: 1px solid #000;*/ }
        ...
        .A4-4-cuotas .box .box_promo h1 .ic-porcentaje { font-size: 68pt; position: absolute; top: 0; right: 2mm;}
        .A4-4-cuotas .box .box_promo h1 .dcto { font-size: 18pt; letter-spacing: 0;}
        ...
        .A4-4-cuotas .box .box_promo h1.solo_porcentaje .porcentaje { font-size: 90pt; line-height: 45pt; }
        ...
        .A4-4-cuotas .box .box_promo h2 { font-size: 46pt; position: relative; color: #E00C15; }
        ...
        .A4-4-cuotas .box .box_promo h2 .ic-porcentaje { font-size: 68pt; position: absolute; top: -5mm; right: 0;}
        .A4-4-cuotas .box .box_promo h2 .dcto { position: absolute; font-size: 18pt; right: 0;}
        .A4-4-cuotas .box .box_promo h2.otro_medio_pago { font-size: 90pt; line-height: 45pt; font-weight: 900; text-align: center;}
        .A4-4-cuotas .box .box_promo h2.otro_medio_pago .todo_pago { position: absolute; top: 4mm; right: 0;}
        ...
        .A4-4-cuotas .box .box_promo .segunda_unidad sup { font-size: 10pt; font-weight: 900;}
        .A4-4-cuotas .box .box_promo .segunda_unidad { text-align: right; position: absolute; right: 0; line-height: 1; top: -16mm; width: 70mm;}
        ...
        /*.con_franja_oferta_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 65px; background-position: 0 0; } */
        ...
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo .img-logo {position: absolute; left: 30mm; top: -4mm; width: 80px;}
    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4-cuotas con_franja_oferta_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div>
