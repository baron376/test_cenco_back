...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4.faldon_03{top: 50%; left: 0;}
        .A4-4.faldon_04{top: 50%; left: 50%;}
        ...
        <div class="A4-4 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_nombre_producto">
                    <h2>Ventilador pedestal <br>kendal 16'' 3 en 1 <br>zf1602rmii metal 0</h2>
                </div>
                <div class="box_promo">
                    <div class="promo">
                ...
                <div class="box_cuotas">
                    <p>15 cuotas de $ 5.148 C.A.E: 3 0,62% Costo total: $ 77.726</p>
                </div>
                <div class="box_precio_normal">
                    <p>Precio normal Unitarrio <strong>$79.990</strong></p>
                </div>
