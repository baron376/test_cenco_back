...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo h1 { font-weight: 900; font-size: 90pt; line-height: 50pt; color: #E00C15; letter-spacing: -2px; }
        ...
        .A4-4-cuotas .box .box_promo h1.prod_por_precio { font-size: 65pt; margin-top: -10px; }
        ...
        .A4-4-cuotas .box .box_franja_inferior {width: 100%; position: absolute; top: 88mm; height: 17mm; left: 0; background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-oferta_a4-4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center;}
        .clear {clear: both}
    </style>
</head>
<body>
