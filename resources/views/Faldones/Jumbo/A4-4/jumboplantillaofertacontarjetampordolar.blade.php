...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4 .box .box_promo h1 { font-weight: 900; font-size: 50pt; line-height: 30pt; color: #E00C15; letter-spacing: -2px; padding-right: 4mm;}
        ...
        .A4-4 .box .box_promo h1.prod_por_precio { font-size: 50pt;  }
        ...
        .A4-4 .box .box_promo h1.prod_por_precio .signo_por { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 4mm; margin-left: 2mm; text-transform: lowercase;}
        ...
        .A4-4 .box .box_promo h2 { font-weight: 900; font-size: 50pt; line-height: 30pt; color: #E00C15; letter-spacing: -2px; }
        ...
        .A4-4 .box .box_cuotas p { font-size: 10pt; line-height: 10pt; margin-top: 1mm;}
        ...
        /*.A4-4.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 60px; background-position: 18mm 0; } */
        
        .A4-4.franja_tarjeta .box .box_promo h1 .ic-porcentaje { font-size: 68pt; position: absolute; top: -14mm; right: 22mm;}
        .A4-4.franja_tarjeta .box .box_promo h1 .dcto { font-size: 21pt; }
        .A4-4.franja_tarjeta .box .box_promo h1.solo_precio { font-size: 85pt; letter-spacing: -1.2mm; margin-top: 0; margin-bottom: 10px; }
        .A4-4.franja_tarjeta .box .box_promo h1.precio_bajada { font-size: 70pt; letter-spacing: -1.2mm; margin-top: -15px; }
        .A4-4.franja_tarjeta .box .box_promo h1.prod_por_precio { font-size: 50pt; }
        .A4-4.franja_tarjeta .box .box_promo h1.n_por_n { font-size: 0; }
        ...
        .A4-4.franja_tarjeta .box .box_promo h1.precio_mas_promo .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 3mm; }
        
        .A4-4.franja_tarjeta .box .box_promo h2 .todo_pago { font-size: 12pt; line-height: 1; text-align: left; margin-left: 10px; color: #000; }
        .A4-4.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: middle;margin-right: 3mm;}
        .A4-4.franja_tarjeta .box .box_promo h2 .punto { font-size: 18pt; }
        .A4-4.franja_tarjeta .box .box_promo h2 .signo_por { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 4mm; margin-left: 2mm; text-transform: lowercase;}
        .A4-4.franja_tarjeta .box .box_promo h2 .ic-porcentaje { font-size: 26pt; position: absolute; top: 2.5mm; right: -8mm;}
        .A4-4.franja_tarjeta .box .box_promo h2 .dcto { position: absolute; font-size: 8pt; top: 14mm; right: -9mm; }
        
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago { position: relative; letter-spacing: -2px;}
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago {position: absolute; line-height: .8; top: 0; left: 6mm; letter-spacing: 0; width: 35mm; text-align: center;}
        ...
        .A4-4.franja_tarjeta .box .box_promo h2.produc_por_precio_otro_pago { font-size: 50pt; line-height: 30pt;}
        ...
        .A4-4.franja_tarjeta .box .box_promo h3 { font-weight: 900; }
        ...
        .A4-4.franja_tarjeta .box .box_promo h1.prod_por_precio,
        ...
        .A4-4.franja_tarjeta .box .box_promo h1.prod_por_precio {top: 0;}
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago {top: 15mm;}
        
        .A4-4.franja_tarjeta .box .box_promo .img-logo {position: absolute; left: 20mm; top: -2mm; width: 60px;}
    </style>
</head>
<body>
