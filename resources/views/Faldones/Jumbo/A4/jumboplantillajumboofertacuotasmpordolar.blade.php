  ...
  <head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo { position: absolute; width: 240mm; height: 84mm; top: 134mm; left: -20mm; text-align: center; padding-top: 25mm; }
        ...
        .A4_cuotas .box .box_condiciones { position: absolute; bottom: 10mm; width: 204mm; height: 34mm; left: 3mm; text-align: left;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h1.prod_por_precio { font-size: 100pt; line-height: 100pt;}
        ...
        .A4_cuotas .box .box_franja_inferior { position: absolute; width: 100%; top: 0; height: 38mm; background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-oferta_a4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center;}
        .A4_cuotas .box .box_cuotas { position: absolute; bottom: 58mm; width: 100%; right: 0; text-align: center; }
        .A4_cuotas .box .box_cuotas p { font-size: 20pt; }
    </style>
  </head>
  <body>
        ...
        <div class="box">
            ...
            <div class="box_promo">
                <div class="promo">
                    ...
                    <h1 class="prod_por_precio"><div class="prod_qty">{{substr($producto->combinacion, 0, -1)}}</div><div class="signo_por">X</div><div class="signo_peso">$</div><div class="prod_precio">{{number_format($producto->tmp, 0, '', '.')}}</div></h1>
                    @else
                    <h1 class="prod_por_precio"><div class="prod_qty">&nbsp;&nbsp;{{substr($producto->combinacion, 0, -1)}}</div><div class="signo_por">X</div><div class="signo_peso">$</div><div class="prod_precio">{{number_format($producto->tmp, 0, '', '.')}}</div></h1>
                    @endif
                </div>
