...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo { position: absolute; width: 204mm; height: 98mm; top: 114mm; right: 4mm; text-align: center; padding-top: 25mm; }
        ...
        .A4_cuotas .box .box_promo h1.prod_por_precio .signo_por { font-size: 40pt; letter-spacing: -10px; vertical-align: middle; margin-right: 3mm; margin-left: 2mm}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h1.prod_por_precio { font-size: 105pt; line-height: 90pt; letter-spacing: -8px;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-tarjeta_a4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
        
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 100px; left:14mm; top: 18mm; }
    </style>
