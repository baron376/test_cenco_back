...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo h1.n_por_n { margin-top: 0; text-transform: lowercase; text-align: left;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 100px; left:14mm; top: 26mm; }
    </style>
</head>
<body>
    <?php $i = 1; ?>
    ...
    <div class="cont-grid cont-a4">     
        <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n">{{$producto->tmp}}</h1>
