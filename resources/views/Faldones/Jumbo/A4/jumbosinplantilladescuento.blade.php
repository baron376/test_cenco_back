...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4 .box .box_precio_normal { position: absolute; bottom: 56mm; height: 4mm; width: 204mm; right: 10mm; text-align: right; /* background-color: bisque; */ }
        ...
        .A4 .box .box_cuotas { position: absolute; bottom: 46mm; width: 100%; right: 0; text-align: center; }
