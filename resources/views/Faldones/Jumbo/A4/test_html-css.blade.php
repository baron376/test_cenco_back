...
<head>
    ...
    <style>
        ...
        .A4_cuotas .box .box_cuotas { position: absolute; bottom: 54mm; width: 100%; right: 0; text-align: center; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 100px; left:19mm; top: 6mm; }
        ...
        <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
            <div class="box">
                ...
                <div class="box_precio_normal">
                    <p>Precio normal Unitario <strong>$ 10.000</strong></p>
                </div>
                <div class="box_cuotas">
                    <p>15 cuotas de $ 5.148 C.A.E: 3 0,62% Costo total: $ 77.726</p>
                </div>
                <div class="box_condiciones">
                    <p class="f-text">EAN: 123456789</p>
                    <p class="s-text"><strong>VALIDAS DESDE EL 00.00.0000 AL 00.00.0000</strong> O HASTA AGOTAR STOCK MAXIMO 12 PROMOCIONES POR PERSONAS. NO APLICA A COMPRAS CON FACTURA. NO ACUMULABLE CON OTRAS PROMOCIONES</p>
                </div>
