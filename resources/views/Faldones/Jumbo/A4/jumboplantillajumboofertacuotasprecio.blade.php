...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4 .box .box_promo h1 { font-weight: 900; font-size: 130pt; line-height: 115pt; color: #E00C15; margin-top: 50px; }
        ...
        .A4 .box .box_franja_inferior { top: 0; height: 38mm; background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-oferta_a4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center;}
