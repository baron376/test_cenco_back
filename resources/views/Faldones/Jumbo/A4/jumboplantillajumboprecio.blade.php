...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4 .box .box_franja_inferior { top: 0; height: 38mm; background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-jumbo_a4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center;}
