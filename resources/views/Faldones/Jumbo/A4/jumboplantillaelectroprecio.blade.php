  ...
  <head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_cuotas { position: absolute; bottom: 55mm; width: 100%; right: 0; text-align: center; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago .todo_pago { text-align: center; position: absolute; top: 8mm; left: 0; letter-spacing: 0; font-size: 18pt; line-height: .8; width: 60mm;}
        ...
        /* .A4_cuotas.franja_oferta_con_tarjeta_cuotas h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 18mm 4mm;} */
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 80px; left:22mm; top: 10mm; }
    </style>
  </head>
