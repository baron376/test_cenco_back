...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_nombre_producto { text-align: center; bottom: 180mm; left: 0; width: 99%; font-size: 38pt; line-height: 50pt; }
        ...
        .A4_cuotas .box .box_promo { position: absolute; width: 240mm; height: 84mm; top: 134mm; left: -15mm; text-align: center; padding-top: 25mm; }
        ...
        .A4_cuotas .box .box_franja_inferior { top: 0; height: 38mm; background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-oferta_a4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center;}
    </style>
</head>
<body>
    <?php $i = 1; ?>
