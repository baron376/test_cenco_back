...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_cuotas { position: absolute; bottom: 55mm; width: 178mm; right: 0; text-align: center; }
        ...
        /*.A4_cuotas.franja_oferta_con_tarjeta_cuotas h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 18mm 0;} */
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 80px; left:22mm; top: 24mm; }
    </style>
</head>
<body>
    <?php $i = 1; ?>
