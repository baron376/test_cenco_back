...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago .todo_pago {text-align: center; font-size: 18pt; line-height: .8; color: #000; position: absolute; top: 18mm; left: 10mm; width: 50mm; letter-spacing: 0;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 100px; left:24mm; top: 10mm; }
    </style>
  </head>
  <body>
    <?php $i = 1; ?>
