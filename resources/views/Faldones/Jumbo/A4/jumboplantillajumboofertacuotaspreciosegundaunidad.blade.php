...
<head>
    ...
    <style>
        ...
        .A4_cuotas .box .box_nombre_producto.large { line-height: 1.25; bottom: 187mm; right: 4mm; }
        .A4_cuotas .box .box_nombre_producto.large h2 { font-size: 19pt; }
        .A4_cuotas .box .box_nombre_producto.medium { line-height: 1.25; bottom: 187mm; right: 4mm;}
        .A4_cuotas .box .box_nombre_producto.medium h2 { font-size: 30pt; }
        .A4_cuotas .box .box_promo { position: absolute; width: 204mm; height: 98mm; top: 130mm; left: 3mm; text-align: center; padding-top: 10mm; }
        .A4_cuotas .box .box_promo h1 { font-weight: 900; font-size: 150pt; line-height: 115pt; color: #E00C15; }
        ...
        .A4_cuotas .box .box_promo h2 sup { font-size: 30pt; font-weight: 800; margin-right: 2px; font-weight: 900;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago { font-size: 44pt; position: absolute; top: 40%; left:-20%}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago .todo_pago { margin-left: 10px;position: absolute; top: 9%; left:61%}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h3.segundad_unidad_tarjeta { position: absolute; top: 0; right: 0; font-size: 40pt; font-weight: 900; }
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.segunda_unidad_cuotas { position: absolute; top: -10%; right: 50mm; color: #000; }
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box_franja_inferior {  background-image: url("{{ public_path('cssFaldones/assets/img/faldon-jumbo-oferta_a4.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
    </style>
</head>
<body>
    <?php $i = 1; ?>
