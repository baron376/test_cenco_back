...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .box .box_nombre_producto { position: absolute; font-weight: 500; text-transform: uppercase; bottom: 165mm; right: 4mm; line-height:1; width: 80%;}
        ...
        .A4-4 .box .box_nombre_producto {height: 23mm; bottom: 183mm; right: 6mm; text-align: right; font-size: 12pt;}
        .A4-4 .box .box_nombre_producto_medium {height: 23mm; width: 80%; bottom: 183mm; right: 6mm; text-align: right; font-size: 10pt; position: absolute;}
        .A4-4 .box .box_nombre_producto_large {height: 23mm; width: 80%; bottom: 183mm; right: 6mm; text-align: right; font-size: 8pt; position: absolute;}
        .A4-4 .box .box_nombre_producto_large.bottom,
        .A4-4 .box .box_nombre_producto_large.bottom,
        .A4-4 .box .box_nombre_producto_medium.bottom,
        .A4-4 .box .box_nombre_producto_medium.bottom,
        .A4-4 .box .box_nombre_producto.bottom,
        .A4-4 .box .box_nombre_producto.bottom {bottom: 78mm !important;}
        .A4-4 .box .box_promo { position: absolute; /* background-color: aquamarine; */ width: 140mm; height: 30mm; left: 4mm; top: 18mm; text-align: right; }
        
        .A4-4 .box .box_promo h1 { font-weight: 900; font-size: 90pt; line-height: 50pt; color: #E00C15; letter-spacing: -2px; }
        ...
        .A4-4 .box .box_promo h1.n_por_n { font-size: 100pt; line-height: 80pt; text-transform: lowercase;}
        .A4-4 .box .box_promo h1.n_por_n .signo_por_big { font-size: 80pt; vertical-align: middle; }
        .A4-4 .box .box_promo h1.n_por_n .porcentaje { font-size: 110pt; line-height: 1; }
        ...
        .A4-4 .box .box_cuotas p { font-size: 12pt; line-height: 10pt; margin-top: 1mm;}
        ...
        /* .A4-4.franja_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 90px; background-position: 30mm 15mm; } */
        ...
        .A4-4.franja_tarjeta .box .box_promo h1.solo_porcentaje .porcentaje { font-size: 90pt; }
        ...
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago { position: relative; margin-right: 40mm; }
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { width: 34mm; position: absolute; line-height: .8; right: -35mm; top: 6mm;}
        ...
        .A4-4.franja_tarjeta .box .box_promo h2.produc_por_precio_otro_pago { font-size: 36pt; margin-top: -34px;}
        ...
        .A4-4.franja_tarjeta .box .box_promo .img-logo {position: absolute; left: 20mm; top: 12mm; width: 90px;}
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+0]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+0]->tc, -1)}}</span></h1>
        ...
        <div class="A4-4 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+1]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+1]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-4 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+2]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+2]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
        ...
        <div class="A4-4 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+3]->tc, 0,1)}}</span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+3]->tc, -1)}}</span></h1>
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
