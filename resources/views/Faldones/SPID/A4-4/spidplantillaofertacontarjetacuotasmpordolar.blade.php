...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo h2 .todo_pago { font-size: 10pt; line-height: .8; text-align: center; color: #000; letter-spacing: 0; position: absolute; left: 21mm; top: 0; width: 35mm;}
        ...
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo h2.otro_medio_pago {right: 6mm;}
        ...
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo .img-logo {position: absolute; left: 26mm; top: -4mm; width: 60px;}
    </style>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago" style="margin: 15px 0 0 0;">{{substr($product[$i+0]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago" style="margin: 15px 0 0 0;">{{substr($product[$i+1]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago" style="margin: 15px 0 0 0;">{{substr($product[$i+2]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago" style="margin: 15px 0 0 0;">{{substr($product[$i+3]->combinacion, 0, -1)}}<span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
