    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_03">
            <div class="box">
                ...
                <div class=" bottom" style="font-size: 12pt; text-align: right; padding: 10px 20px 0 95px; line-height: 1;">
                ...
                <div class=" bottom" style="font-size: 10pt; text-align: right; padding: 10px 20px 0 95px; line-height: 1;">
                    <h2>{{$product[$i+2]->nombre_generico_promocion}}</h2>
                </div>
                @endif
