...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .box .box_nombre_producto { position: absolute; font-weight: 500; text-transform: uppercase; top: 30mm; right: 4mm; line-height:1; width: 80%; height: 18mm;}
        ...
        .A4-4-cuotas .box .box_nombre_producto { top: 6mm; right: 6mm; text-align: right; font-size: 11pt;}
        ...
        .con_franja_oferta_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 65px; background-position: 0 50%; }
        ...
        .con_franja_oferta_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { font-size: 10pt; margin-left: 47px; }
        ...
        <div class="A4-4-cuotas con_franja_oferta_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_nombre_producto">
                    ...
                    <h2>zf1602rmii metal 1</h2>
                </div>
                <div class="box_promo">
                    <div class="promo">
                        <h3 class="segunda_unidad">2<sup>DA</sup> UNIDAD<br> CON TARJETA</h3>
                        <h1 class="solo_precio"><span class="signo_peso">$</span>10<span class="punto">.</span>299</h1>
                        <h2><span class="signo_peso">$</span>10<span class="punto">.</span>399 <div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                    </div>
                </div>
                ...
                <div class="box_condiciones">
                    ...
                    <p class="s-text"><strong>VALIDAS DESDE EL 29/11/2019 AL 31/12/2019</strong> O HASTA AGOTAR STOCKMAXIMO 12 PROMOCIONES POR PERSONAS. OFERTAS EN CARNES ROJAS Y BLANCAS MAXIMO 10 KILOS POR PERSONA. NO APLICA A COMPRAS CON FACTURA. NO ACUMULABLE CON OTRAS PROMOCIONES</p>
                </div>
