...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4 .box .box_nombre_producto {height: 23mm; bottom: 183mm; right: 6mm; text-align: right; font-size: 15pt;}
        ...
        .A4-4 .box .box_promo { position: absolute; /* background-color: aquamarine; */ width: 140mm; height: 30mm; left: 4mm; top: 35mm; text-align: right; }

        .A4-4 .box .box_promo h1 { font-weight: 900; font-size: 45pt; line-height: 30pt; color: #E00C15; letter-spacing: -2px; padding-right: 4mm;}
        .A4-4 .box .box_promo h1 .signo_peso { font-size: 25pt; vertical-align: bottom; /*margin-right: 2mm; */}
        ...
        .A4-4.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 25pt; vertical-align: middle; }
        ...
        .A4-4.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { position: absolute; left: 17mm; top: 2mm; letter-spacing: 0; width: 35mm; text-align: center; line-height: .8;}
        ...
        .A4-4.franja_tarjeta .box .box_promo h3 { font-weight: 900; margin-top: -10mm; }
        ...
        .A4-4.franja_tarjeta .box .box_promo .img-logo {position: absolute; left: 30mm; top: -2mm; width: 60px;}
    </style>
</head>
<body>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago"><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
