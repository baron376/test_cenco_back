...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box .box_promo h1.prod_por_precio .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: center; margin-right: 3mm; }
        .A4-4-cuotas .box .box_promo h1.prod_por_precio .signo_por { font-size: 21pt; letter-spacing: -10px; vertical-align: center; margin-right: 4mm; margin-left: 2mm; }
        ...
        .A4-4-cuotas .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 90px; background-position: 0 0;}
    ...
    <div class="cont-grid cont-a4-4">
        <div class="A4-4-cuotas con_franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio">2<span class="signo_por">X</span><span class="signo_peso">$</span>30<span class="punto">.</span>000</h1>
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_03">
            <div class="box">
                <div class="box_qr"></div>
                <div class="box_nombre_producto">
                    <h2>Ventilador pedestal</h2>
                    <h2>kendal 16'' 3 en 1</h2>
                    <h2>zf1602rmii metal</h2>
                </div>
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio solo_prod_por_precio">2<span class="signo_por">X</span><span class="signo_peso">$</span>30<span class="punto">.</span>000</h1>
    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_cuotas">
                    <p>{{$product[$i+0]->cuotas}} cuotas de $ {{number_format($product[$i+0]->valor_cuota, 0, '', '.')}}</p>
                    <p>C.A.E: {{$product[$i+0]->cae}}% Costo total: $ {{number_format($product[$i+0]->costo_total, 0, '', '.')}}</p>
                </div>
                @endif
                <div class="box_precio_normal">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_02">
            <div class="box">
                ...
                <div class="box_cuotas">
                    <p>{{$product[$i+1]->cuotas}} cuotas de $ {{number_format($product[$i+1]->valor_cuota, 0, '', '.')}}</p>
                    <p>C.A.E: {{$product[$i+1]->cae}}% Costo total: $ {{number_format($product[$i+1]->costo_total, 0, '', '.')}}</p>
                </div>
                @endif
                <div class="box_precio_normal">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_03">
            <div class="box">
                ...
                <div class="box_cuotas">
                    <p>{{$product[$i+2]->cuotas}} cuotas de $ {{number_format($product[$i+2]->valor_cuota, 0, '', '.')}}</p>
                    <p>C.A.E: {{$product[$i+2]->cae}}% Costo total: $ {{number_format($product[$i+2]->costo_total, 0, '', '.')}}</p>
                </div>
                @endif
                <div class="box_precio_normal">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_04">
            <div class="box">
                ...
                <div class="box_cuotas">
                    <p>{{$product[$i+3]->cuotas}} cuotas de $ {{number_format($product[$i+3]->valor_cuota, 0, '', '.')}}</p>
                    <p>C.A.E: {{$product[$i+3]->cae}}% Costo total: $ {{number_format($product[$i+3]->costo_total, 0, '', '.')}}</p>
                </div>
                @endif
                <div class="box_precio_normal">
