...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .box .box_nombre_producto_large { position: absolute; font-weight: 500; text-transform: uppercase; right: 4mm; line-height:.8; width: 80%;}
        ...
        .A4-4-cuotas.con_franja_oferta_tarjeta { height: 105mm; width: 148.5mm; position: absolute;}
        ...
        .A4-4-cuotas .box .bg-producto { position: absolute; height: 16mm; width: 80%; top: 4mm; right: 6mm; /* background-color: aqua; */ }
        .A4-4-cuotas .box .box_nombre_producto {height: 23mm; bottom: 183mm; right: 6mm; text-align: right; font-size: 11pt;}
        ...
        .A4-4-cuotas .box .box_promo { position: absolute; /* background-color: aquamarine; */ width: 140mm; height: 35mm; left: 4mm; top: 28mm; text-align: right; }

        .A4-4-cuotas .box .box_promo h1 { font-weight: 900; font-size: 50pt; line-height: 30pt; color: #E00C15; letter-spacing: -2px; padding-right: 4mm;}
        ...
        .A4-4-cuotas .box .box_promo h1.prod_por_precio { font-size: 55pt; }
        ...
        .A4-4-cuotas .box .box_promo h1.solo_prod_por_precio { font-size: 70pt; margin-top: 10px; }
        ...
        .A4-4-cuotas .box .box_promo h2 { font-size: 46pt; color: #E00C15; font-weight: 900;letter-spacing: -2px;}
        .A4-4-cuotas .box .box_promo h2 .todo_pago { font-size: 10pt; line-height: .8; text-align: center; color: #000; letter-spacing: 0; position: absolute; left: 2mm; top: 0; width: 35mm;}
        .A4-4-cuotas .box .box_promo h2 .signo_peso { font-size: 21pt; vertical-align: middle; letter-spacing: -10px; margin-right: 3mm;}
        ...
        .A4-4-cuotas .box .box_promo h2.produc_por_precio_otro_pago { font-size: 55pt; line-height: 30pt; text-align: right;}
        ...
        /*.con_franja_oferta_tarjeta .box .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 55px; background-position: 12mm 0; } */
        .A4-4.con_franja_oferta_tarjeta .box .box_promo h2.produc_por_precio_otro_pago { font-size: 55pt; line-height: 30pt;}
        .A4-4.con_franja_oferta_tarjeta .box .box_promo h2.segunda_unidad { font-size: 40pt; margin-left: 250px;}
        .A4-4.con_franja_oferta_tarjeta .box .box_promo h2.segunda_unidad .ic-porcentaje { font-size: 28pt; left: 73px; margin-top: -10px; }
        .A4-4.con_franja_oferta_tarjeta .box .box_promo h2.segunda_unidad .dcto { font-size: 8pt; left: 75px; bottom: 15px; }
        .A4-4.con_franja_oferta_tarjeta .box .box_promo h3 { font-weight: 900; }
        .A4-4.con_franja_oferta_tarjeta .box .box_promo h3 sup { font-size: 8pt; }
        
        .con_franja_oferta_tarjeta .box .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/spid-faldon-a4-4.jpg')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
        .clear {clear: both}

        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo h1.prod_por_precio,
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo h2.otro_medio_pago {position: absolute; height: 15mm; right: 2mm; /*border: 1px solid #000;*/ width: 100%;}
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo h1.prod_por_precio {top: 0;}
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo h2.otro_medio_pago {top: 15mm;}
        
        .A4-4-cuotas.con_franja_oferta_tarjeta .box .box_promo .img-logo {position: absolute; left: 12mm; top: -4mm; width: 60px;}
    </style>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago">{{substr($product[$i+0]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago">{{substr($product[$i+1]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago">{{substr($product[$i+2]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h2 class="otro_medio_pago produc_por_precio_otro_pago">{{substr($product[$i+3]->combinacion, 0, -1)}}<span class="signo_por">x</span><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}} <div class="todo_pago">CON&nbsp;OTRO &nbsp;MEDIO&nbsp;DE&nbsp;PAGO</div></h2>
                        @endif
                        <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.svg')}}" alt="" class="img-logo">
                    </div>
                </div>
