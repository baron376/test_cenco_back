...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4-cuotas .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 0 0;}
    ...
    <div class="cont-grid cont-a4-4">
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n">{{$product[$i+0]->tmp}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n">{{$product[$i+1]->tmp}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n">{{$product[$i+2]->tmp}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-4-cuotas con_franja_oferta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n">{{$product[$i+3]->tmp}}</span></h1>
                    </div>
                </div>
