...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4 .box .box_promo { position: absolute; width: 204mm; height: 94mm; top: 120mm; right: 2mm; text-align: center; padding-top: 0; }
        ...
        .A4 .box .box_promo h1.precio_mas_promo { font-size: 180pt; margin-top: 0;}
        ...
        .A4 .box .box_cuotas { position: absolute; bottom: 52mm; width: 178mm; right: 0; text-align: center; line-height: 1;}
        ...
        .A4 .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/spid-faldon-a4.jpg')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
        .A4 .box_promo h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 0 0;}
    </style>
</head>
<body>
        ...
        <div class="A4 con-franja">
            <div class="box">
                <div class="box_nombre_producto">
                    <h2>VENTILADOR PEDESTAL <br>KENDAL 16” 3 EN 1 <br>ZF1602RMII METAL</h2>
                </div>
                <div class="box_promo">
                    <div class="promo">
                ...
                <div class="box_precio_normal">
                    <p>Precio normal Unitario <strong>00.000</strong></p>
                </div>
                <div class="box_cuotas">
                    <p>00 cuotas de $000.000</p>
                    <p>C.A.E: 00.00% Costo total: $ 000.000</p>
                </div>
                <div class="box_condiciones">
                    <p class="f-text">EAN: 1234567</p>
                    <p class="s-text"><strong>VALIDAS DESDE EL 00/00/0000 AL 00/00/0000</strong> O HASTA AGOTAR STOCK MAXIMO 12 PROMOCIONES POR PERSONAS. OFERTAS EN CARNES ROJAS Y BLANCAS MAXIMO 10 KILOS POR PERSONA. NO APLICA A COMPRAS CON FACTURA. NO ACUMULABLE CON OTRAS PROMOCIONES</p>
                </div>
