...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_nombre_producto.large{ text-align: center; top: 48mm; width: 100%; font-size: 18pt; line-height: .8; letter-spacing: -2pt; }
        ...
        .A4_cuotas .box .box_precio_normal { position: absolute; bottom: 76mm; height: 4mm; width: 204mm; right: 10mm; text-align: right;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 0 50%;}
    ...
    <div class="cont-grid cont-a4">
        <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="jumbo-puntos">10<span class="punto">.</span>000</h1>
                        <h2 class="sisa-puntos_bajada">PUNTOS CENCOSUD</h2>
                        <h3 class="mas_puntos"><span>+</span><span class="signo_peso">$</span>20<span class="punto">.</span>990</h3>
                    </div>
                </div>
