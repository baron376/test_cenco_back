...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo { position: absolute; width: 204mm; height: 86mm; top: 118mm; right: 2mm; text-align: center; padding-top: 0; }
        .A4_cuotas .box .box_promo h1 { font-weight: 900; font-size: 133pt; line-height:160pt; color: #E00C15; letter-spacing: -2px; }
        ...
        .A4_cuotas .box .box_promo h1.precio_mas_promo { font-size: 160pt; /*margin-top: -50px;*/ }
        ...
        .A4_cuotas .box .box_promo h2 sup { font-size: 30px; font-weight: 900; margin-right: 2px; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.segunda_unidad_cuotas {right: 10mm; color: #000; }
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.segunda_unidad_cuotas sup { font-size: 28pt; }
        .A4_cuotas.franja_oferta_con_tar jeta_cuotas .box .box_promo h3 sup { font-size: 16pt; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/spid-faldon-a4.jpg')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; }
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h1 class="precio_mas_promo"><span class="signo_peso">$</span>{{number_format($producto->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
