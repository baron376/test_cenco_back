...
<head>
    ...
    <style>
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2 .ic-porcentaje { font-size: 130pt; position: absolute ; top: -18mm; right: 0;}
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2 .porcentaje { font-size: 165pt; line-height: 135pt;}
        ...
        /* .A4_cuotas.franja_oferta_con_tarjeta_cuotas h1 { background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta_sincuotas_color.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 14mm 10mm;} */
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 100px; left:14mm; top: 10mm; }
    </style>
  </head>
  <body>
    <?php $i = 1; ?>
        ...
        <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
            <div class="box">
                ...
                <div class="box_promo">
                    ...
                    <h1 class="porcentaje_mas_promo"><span class="porcentaje">{{$producto->tc}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    @if($producto->tmp > 0)
