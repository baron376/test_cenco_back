...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4_vert_1 .box .box_promo h1 .signo_por { font-size: 21pt; position:absolute ; top:-1%;left: 37%; }
        .A4-4_vert_1 .box .box_promo h1 .prod_qty { position:absolute ;top:0%;left: 27%;}
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 12pt; vertical-align: middle; position: absolute; top: 6mm;left:-2mm;}
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .punto { font-size: 18pt; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .signo_por { position: absolute; top: 6mm;left:-5mm; font-size: 14pt; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .prod_qty { position: absolute; top: 6mm;left:-8mm; font-size: 14pt; }
    ...
    <div class="cont-grid cont-a4-4_sisa">
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+0]->tmp, 0,1)}}</span></span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+0]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+1]->tmp, 0,1)}}</span></span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+1]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+2]->tmp, 0,1)}}</span></span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+2]->tmp, -1)}}</span></h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($product[$i+3]->tmp, 0,1)}}</span></span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($product[$i+3]->tmp, -1)}}</span></h1>
                    </div>
                </div>
