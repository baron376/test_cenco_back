...
<meta charset="UTF-8">
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        /* .A4-4_vert_1.franja_tarjeta .box .box_promo h1 { background-image:url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta2.png')}}"); background-repeat: no-repeat; background-size: 65px; background-position: 8mm 50%;} */
        .A4-4_vert_1.franja_tarjeta .box .box_promo .img-logo { position: absolute; width: 60px; left:14mm; top: 4mm; }
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2.otro_medio_pago { }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { position: absolute; top: 8mm; left: 7mm; line-height:.8; letter-spacing: 0; width: 25mm; text-align: center;}
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h1.solo_porcentaje {top: -1.5mm;}
    ...
    <div class="cont-grid cont-a4-4_sisa">
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="box_promo">
                    ...
                    <h1 class="solo_porcentaje todo_pago"><span class="porcentaje">{{$product[$i+0]->tc}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    @if($product[$i+0]->tmp > 0)
                    <h2 class="otro_medio_pago">{{$product[$i+0]->tmp}}<div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span><div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                    @endif
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <h3>2<sup>DA</sup> UNIDAD CON TARJETA</h3>
                    <h1 class="solo_porcentaje todo_pago"><span class="porcentaje">{{$product[$i+1]->tc}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    @if($product[$i+1]->tmp > 0)
                    <h2 class="otro_medio_pago">{{$product[$i+1]->tmp}}<div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span><div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                    @endif
                    <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta2.svg')}}" alt="" class="img-logo">
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <h3>2<sup>DA</sup> UNIDAD CON TARJETA</h3>
                    <h1 class="solo_porcentaje todo_pago"><span class="porcentaje">{{$product[$i+2]->tc}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    @if($product[$i+2]->tmp > 0)
                    <h2 class="otro_medio_pago">{{$product[$i+2]->tmp}}<div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span><div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                    @endif
                    <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta2.svg')}}" alt="" class="img-logo">
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <h3>2<sup>DA</sup> UNIDAD CON TARJETA</h3>
                    <h1 class="solo_porcentaje todo_pago"><span class="porcentaje">{{$product[$i+3]->tc}}</span><div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span></h1>
                    @if($product[$i+3]->tmp > 0)
                    <h2 class="otro_medio_pago">{{$product[$i+3]->tmp}}<div class="ic-porcentaje">%</div><span class="dcto">DCTO.</span><div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
                    @endif
                    <img src="{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta2.svg')}}" alt="" class="img-logo">
                </div>
