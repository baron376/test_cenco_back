...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4_vert_1 .box .box_promo { position: absolute; width: 99mm; height: 20mm; left: 2mm; top: 40mm; text-align: right;}
        ...
        .A4-4_vert_1 .box .box_promo h1 .signo_peso { font-size: 35pt; letter-spacing: 10px; vertical-align: bottom;}
        ...
        .A4-4_vert_1 .box .box_promo h1 .signo_por { font-size: 21pt; letter-spacing: 10px ; vertical-align: bottom;}
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h1.prod_por_precio { font-size: 50pt; }
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .todo_pago { font-size: 9.2pt; line-height: 1; text-align: left; margin-left: 30%; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .signo_peso { font-size: 21pt; letter-spacing: -10px; vertical-align: middle; margin-right: 3mm; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .punto { font-size: 18pt; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2 .signo_por { font-size: 21pt; letter-spacing: 10px; vertical-align: center; margin-right: 4mm; margin-left: 2mm;}
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2.otro_medio_pago { position: absolute; top: 40mm; left: -15mm;}
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { position: absolute; width: 100px;top: 30px;left: 80px; line-height: 0.7;}
        .A4-4_vert_1.franja_tarjeta .box .box_promo h3 { font-weight: 800; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h3 sup { font-size: 8pt; }
        .A4-4_vert_1.franja_tarjeta .box .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/faldon-sisa.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; width:100%;position:absolute;bottom: 0;}
        .clear {clear: both}
    </style>
</head>
<body>
    ...
    <div class="cont-grid cont-a4-4_sisa">
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_01">
            <div class="box">
                ...
                <div class="" style="font-size: 9.5pt; text-align: right; ppadding: 120px 20px 0 20px; line-height: 1;">
                    <h2>{{$product[$i+0]->nombre_generico_promocion}}</h2>
                </div>
                @endif
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio"><span class="prod_qty">{{substr($product[$i+0]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+0]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio"><span class="prod_qty">{{substr($product[$i+1]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+1]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class=" bottom" style="font-size: 9.5pt; text-align: right; ppadding: 120px 20px 0 20px; line-height: 1;">
                    <h2>{{$product[$i+2]->nombre_generico_promocion}}</h2>
                </div>
                @endif
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio"><span class="prod_qty">{{substr($product[$i+2]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+2]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="prod_por_precio"><span class="prod_qty">{{substr($product[$i+3]->combinacion, 0, -1)}}</span><span class="signo_por">X</span><span class="signo_peso">$</span>{{number_format($product[$i+3]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
