...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4 .box .box_nombre_producto_medium h2 { font-size: 20pt; }
        ...
        .A4-4_vert_1 .box .box_nombre_producto_medium {height: 23mm; width: 80%; bottom: 248mm; right: 6mm; text-align: right; font-size: 8pt; position: absolute; }
        /* .A4-4_vert_1 .box .box_nombre_producto_medium {height: 23mm; width: 80%; bottom: 248mm; right: 6mm; text-align: right; font-size: 10pt; position: absolute; color: green; } */
        ...
        .A4-4_vert_1 .box .box_franja_inferior { background-image: url("{{ public_path('cssFaldones/assets/img/faldon-sisa.png')}}"); background-repeat: no-repeat; background-size: cover; background-position: center; width:100%;position:absolute;bottom: 0;}
