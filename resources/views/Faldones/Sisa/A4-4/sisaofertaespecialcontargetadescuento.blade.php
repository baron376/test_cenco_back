...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .box .box_nombre_producto { position: absolute; font-weight: 500; text-transform: uppercase; top: 26mm; right: 4mm; line-height:.8; width: 90%;}
        .box .box_nombre_producto h2 { margin-bottom: -2mm; }
        .box .box_nombre_producto h2:last-child { margin-bottom: 0; }
        .box .box_nombre_producto_large { position: absolute; font-weight: 500; text-transform: uppercase; right: 4mm; line-height:1; width: 90%;}
        ...
        .A4-4_vert_1 .box .box_promo { position: absolute; width: 99mm; height: 44mm; left: 2mm; top: 55mm; text-align: right;}
        ...
        /* .A4-4_vert_1.franja_tarjeta .box .box_promo h1 { background-image:url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta2.png')}}"); background-repeat: no-repeat; background-size: 55px; background-position: 8mm 50%;} */
        .A4-4_vert_1.franja_tarjeta .box .box_promo .img-logo { position: absolute; width: 60px; left:22mm; top: 4mm; }
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2.otro_medio_pago .todo_pago { position: absolute; top: 8mm; left: 12mm;  line-height:1; letter-spacing: 0; text-align: center;width:25mm}
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h1.solo_porcentaje,
        .A4-4_vert_1.franja_tarjeta .box .box_promo h2.otro_medio_pago {position: absolute; /*border: 1px solid #000;*/ letter-spacing: -1mm; height: 20mm; right: 0; width: 99%;}
