...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4_vert_1 .box .box_nombre_producto {height: 23mm; bottom: 248mm; right: 6mm; text-align: right; font-size: 11.5pt; /*background-color: red;*/}
        /* .A4-4_vert_1 .box .box_nombre_producto {height: 23mm; bottom: 248mm; right: 6mm; text-align: right; font-size: 14pt; color: red;} */
        .A4-4_vert_1 .box .box_nombre_producto_medium {height: 23mm; width: 80%; bottom: 248mm; right: 6mm; text-align: right; font-size: 8.5pt; position: absolute;background-color: red;}
        ...
        .A4-4_vert_1 .box .box_nombre_producto_large {height: 23mm; width: 80%; bottom: 248mm; right: 6mm; text-align: right; font-size: 7pt; position: absolute;background-color: red;}
        ...
        .A4-4_vert_1 .box .box_condiciones p.s-text strong { letter-spacing: -0.11mm; }
