...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4-4_vert_1 .box .box_promo { position: absolute; width: 99mm; height: 44mm; left: 2mm; top: 65mm; text-align: right; }
        ...
        .A4-4_vert_1.franja_tarjeta .box .box_promo h3.segundad_unidad_tarjeta { font-weight: 800; }
        .A4-4_vert_1.franja_tarjeta .box .box_promo h3 sup { font-size: 8pt; }

        .A4-4_vert_1.franja_tarjeta sup { font-size: 12pt; font-weight: 900;}
        .A4-4_vert_1.franja_tarjeta .box .box_promo .segunda_unidad { position: absolute; right: 15%; top:-4mm; font-size: 20pt;}
        .A4-4_vert_1.franja_tarjeta .box .box_promo .segunda_unidad sup { font-size: 12pt; }
        .clear {clear: both}
            ...
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        ...
                        <h1 class="precio_mas_promo"><span class="signo_peso">$</span> {{number_format($product[$i+0]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_02">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="precio_mas_promo"><span class="signo_peso">$</span> {{number_format($product[$i+1]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_03">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="precio_mas_promo"><span class="signo_peso">$</span> {{number_format($product[$i+2]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
        ...
        <div class="A4-4_vert_1 franja_tarjeta faldon_04">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <b><div class="segunda_unidad">2<sup>DA</sup> UNIDAD<br></div></b>
                        <h1 class="precio_mas_promo"><span class="signo_peso">$</span> {{number_format($product[$i+3]->tmp, 0, '', '.')}}</h1>
                    </div>
                </div>
