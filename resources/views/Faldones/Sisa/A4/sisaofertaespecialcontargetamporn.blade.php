...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo h1 { font-weight: 900; font-size: 200pt; line-height: 115pt; color: #000; letter-spacing: -2px; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2 { color: #000; }
        ...
        /*.A4_cuotas.franja_oferta_con_tarjeta_cuotas h1 {background-image: url("{{ public_path('cssFaldones/assets/img/logo_oferta_tarjeta.png')}}"); background-repeat: no-repeat; background-size: 100px; background-position: 18mm 4mm; } */
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 90px; left:18mm; top: 22mm; }
    ...
    <div class="cont-grid cont-a4">
        <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($producto->tc, 0,1)}}</span><span class="signo_por_big">x</span><span class="porcentaje">{{substr($producto->tc, -1)}}</span></h1>
