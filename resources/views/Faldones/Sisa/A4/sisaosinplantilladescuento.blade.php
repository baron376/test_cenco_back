...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4 .box .box_nombre_producto { text-align: center; bottom: 165mm; left: 0; width: 99%; font-size: 38pt; line-height: 50pt; }
        ...
        .A4 .box .box_promo h1 { font-weight: 900; font-size: 133pt; line-height: 115pt; color: #000000; letter-spacing: -2px; margin-top: 50px; }
        ...
        .A4 .box .box_promo .ic-porcentaje { font-weight: 900; font-size: 190pt; line-height: 190pt; color: #000000;position: absolute;top:-5mm;right:30mm} 
    ...
    <div class="cont-grid cont-a4">
        <div class="A4">
            <div class="box">
                ...
                <div class="box_promo">
                    <h1><span class="porcentaje">{{$producto->tmp}}</span><span class="dcto">DCTO.</span></h1>
