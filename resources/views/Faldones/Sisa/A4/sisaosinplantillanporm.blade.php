...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo h1 { font-weight: 900; font-size: 200pt; line-height: 115pt; color: #000000; letter-spacing: -2px; }
    ...
    <div class="cont-grid cont-a4">
        <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
            <div class="box">
                ...
                <div class="box_promo">
                    <div class="promo">
                        <h1 class="n_por_n"><span class="porcentaje">{{substr($producto->tmp, 0,1)}}</span></span><span class="signo_por_big">X</span><span class="porcentaje">{{substr($producto->tmp, -1)}}</span></h1>
                    </div>
                </div>
