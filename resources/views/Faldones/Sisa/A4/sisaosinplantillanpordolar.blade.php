...
<head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_nombre_producto { text-align: center; bottom: 165mm; left: 0; width: 99%; font-size: 38pt; line-height: 50pt; }
        ...
        .A4_cuotas .box .box_promo { position: absolute; width: 240mm; height: 98mm; top: 120mm; left: -20mm; text-align: center; padding-top: 25mm; }
        .A4_cuotas .box .box_promo h1 { font-weight: 900; font-size: 133pt; line-height: 115pt; color: #000000; letter-spacing: -2px; }
        ...
        .A4_cuotas .box .box_promo h1 .prod_qty { position:absolute ;top: 14%;left: 12%; align-content: right;}
        .A4_cuotas .box .box_promo h1 .prod_precio { position:absolute ;top: 14%;left: 38%;}
        .A4_cuotas .box .box_promo h1 .dcto { font-size: 50pt; padding-left:50%}
        .A4_cuotas .box .box_promo h1 .porcentaje { font-size: 250pt; line-height: 80pt;position: absolute; left: 30mm; top:-mm}
        ...
        .A4_cuotas .box .box_promo h1.prod_por_precio { font-size: 90pt; letter-spacing: 0;}
        .A4_cuotas .box .box_promo h1.prod_por_precio .signo_peso { font-size: 30pt; letter-spacing: -10px; vertical-align: top; margin-right: 3mm;  position:absolute ;top:27%;left: 36%;}
        .A4_cuotas .box .box_promo h1.prod_por_precio .signo_por { font-size: 40pt; letter-spacing: -10px; vertical-align: top; margin-right: 3mm; position:absolute ;top:25%;left: 32%;}
        ...
        .A4_cuotas .box .box_precio_normal { position: absolute; bottom: 20mm; height: 4mm; width: 204mm; right: 50mm; text-align: right;}
        ...
        .A4_cuotas .box .box_condiciones { position: absolute; bottom: -15mm; width: 204mm; height: 34mm; left: 25mm; text-align: left;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h1.prod_por_precio { font-size: 120pt; }
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2 { color: #000000; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2 .prod_qty { position: absolute; top: 6%; left:10%; font-size: 21pt; }
    ...
    <div class="cont-grid cont-a4">
      <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
        <div class="box">
            ...
            <div class="box_promo">
                <div class="promo">
                    @if(strlen(substr($producto->combinacion, 0, -1)) > 1)
                    <h1 class="prod_por_precio"><div class="prod_qty">{{substr($producto->combinacion, 0, -1)}}</div><div class="signo_por">X</div><div class="signo_peso">$</div><div class="prod_precio">{{number_format($producto->tmp, 0, '', '.')}}</h1>
                    @else
                    <h1 class="prod_por_precio"><div class="prod_qty">&nbsp;&nbsp;{{substr($producto->combinacion, 0, -1)}}</div><div class="signo_por">X</div><div class="signo_peso">$</div><div class="prod_precio">{{number_format($producto->tmp, 0, '', '.')}}</h1>
                    @endif
                </div>
