  ...
  <head>
    ...
    <style>
        * { box-sizing: border-box; padding: 0; margin: 0; }
        ...
        .A4_cuotas .box .box_promo { position: absolute; width: 204mm; height: 80mm; top: 114mm; left: 3mm; text-align: center; padding-top: 10mm; /* border: solid 1px #000; */}
        .A4_cuotas .box .box_promo h1 { font-weight: 900; font-size: 130pt; line-height: 80pt; color: #000; letter-spacing: -2px; }
        .A4_cuotas .box .box_promo h1 .signo_peso { font-size: 35pt; vertical-align: middle; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago { font-weight: 900; font-size: 100pt; line-height: 80pt; letter-spacing: -2px; text-align: right; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago .todo_pago { text-align: center; position: absolute; top: 8mm; left: 0; letter-spacing: 0; font-size: 21pt; line-height: 16pt; width: 60mm;}
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2 .signo_peso { font-size: 35pt; vertical-align: middle; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.segunda_unidad_cuotas { position: absolute; top: -5%; right: 10%; font-size: 32pt; right: 10px; color: #000; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .img-logo { position: absolute; width: 100px; left:18mm; top: 18mm; }
        ...
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h2.otro_medio_pago { position: absolute; height: 48mm; width: 204mm; right: 0; color: #000;}
        .A4_cuotas.franja_oferta_con_tarjeta_cuotas .box .box_promo h1.porcentaje_mas_promo { top: 0; }
    ...
    <div class="cont-grid cont-a4">
      <div class="A4_cuotas franja_oferta_con_tarjeta_cuotas">
        <div class="box">
          ...
          <div class="box_promo">
            <div class="promo">
              <h1 class="solo_precio"><span class="signo_peso">$</span>{{number_format($producto->tc, 0, '', '.')}}</h1>
              @if($producto->tmp > 0)
              <h2 class="otro_medio_pago"><span class="signo_peso">$</span>{{number_format($producto->tmp, 0, '', '.')}}<div class="todo_pago">CON  OTRO MEDIO DE PAGO</div></h2>
              @endif
