		...
		<thead style="width: 100%; border-bottom: 2px solid #0B5A97;">
			<tr>
				<td width="75%" class="h5 white" style="">
                  <h4 style="color:#0B5A97; font-size: 28px; line-height: 1; padding: 0 12px 0 10px;">NUEVA CAMPAÑA PROVEEDOR <strong>CREADA</strong></strong></h4>
               </td>
			   <td>
		...
		<tbody style="vertical-align: top; width: 100%;">
			...
			<tr width="100%">
				<td width="75%">
					<table width="100%">
						<tr>
							<td class="text pb20" style="color:#777777; font-family:'Noto Sans', sans-serif; font-size:16px; line-height: 1.5; text-align:left; padding-bottom:20px;"> Informamos que se ha creado correctamente la campaña <b>"{{$campana->nombre}}"</b>.
							<br><br>
							<span style="color: #D71314; font-size: 14px; line-height: 1.2; font-weight: bold;">¡RECUERDA!</span><br>
							<span style="font-size: 12px; line-height: 1.1;"> Ingresar a la plataforma y subir la ficha técnica en formato PDF para su revisión.</span>
							</td>
						</tr>
						<tr>
							...
							<a href="{{ config('app.front')}}/LoginPro" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;">Ir a Cencocheck</span></a></div>
							</td>
						</tr>
					</table>
				</td>
