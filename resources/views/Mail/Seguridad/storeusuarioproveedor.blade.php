   ...
   <span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">*|MC_PREVIEW_TEXT|*</span>
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <thead style="width: 100%; border-bottom: 2px solid #0B5A97;">
         <tr width="100%">
            <td width="50%" class="h5 white" style="">
               <h4 style="color:#0B5A97; font-size: 28px; line-height: 1; padding: 0 12px 0 10px; margin:0;">BIENVENIDO</h4>
            </td>
            <td>
      ...
      <tbody style="vertical-align: top; width: 100%;">
         ...
         <tr width="100%">
            <td width="80%">
               <table width="100%">
                  <tr>
                     <td class="text pb20" style="color:#777777; font-family:'Noto Sans', sans-serif; font-size:16px; line-height: 1.5; text-align:left; padding-bottom:20px;"> Has sido registrad@ en la plataforma <B>CENCOCHECK</B> de Cencosud Media satisfactoriamente. Para acceder debes ingresar con tu  {{$usuario->email}}  y contraseña :{{$usuario->password_mod}}
                     <br>
                     <img src="{{ config('app.url')}}/ImgPublic/logo-cencomedia-negativo.png" style="width: 100px; padding-top: 20px;">
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <table border="0" cellspacing="0" cellpadding="0">
                           <tr>
                              <td >
                                 <div class="text-button" style="background:#114490; color:#ffffff; font-size:14px; line-height:18px; padding:12px 20px; text-align:center; border-radius:6px;"><a href="{{ config('app.front')}}/LoginPro" target="_blank" class="link-white" style="color:#ffffff; text-decoration:none;"><span class="link-white" style="color:#ffffff; text-decoration:none;"> Iniciar Sesión</span></a></div>
                              </td>
                           </tr>
                        </table>
                     </td>
